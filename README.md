...
Time window dropdown in the header control the range shown across all widgets. Supports light and dark themes — toggle with the moon button in the header. Preferences are saved across page loads.
